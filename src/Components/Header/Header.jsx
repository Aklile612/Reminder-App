    ...
    <div >
      <div className='flex bg-[#1F2937] md:h-13  justify-between items-center'>
        ...
        <div className=''>
          ...
          <Link to="/" className='group md:w-[90px] md:h-9 bg-[#3b3a3a] rounded-[10px] flex gap-1.5 hover:ease-out hover:scale-110 transition-all  justify-center items-center border-[1px]'>
