  ...
  return (
    <div>
      ...
      <div className='md:ml-[25vw] md:mt-[10vh] flex flex-col md:gap-5'>
        ...
        {/* get strted button */}
        <Link to="/register" className=' hover:ease-out hover:scale-110 transition-all delay-75 hover:border-amber-600 hover:border-2 flex justify-center items-center  md:w-[10vw] md:h-[50px] md:mt-[6vh] md:ml-[44vw] bg-[#1F2937] rounded-[6px]'>
